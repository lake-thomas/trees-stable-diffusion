"""
Python script to split Autoarborist and iNaturalist images for stable diffusion lora fine-tuning, cnn training, and cnn testing.
"""
...
SD_ROOT = Path.home() / "Desktop" / "sd1.5"
